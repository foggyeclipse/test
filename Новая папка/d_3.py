    ...
    for contour in contours:
        if obj_class == 'tree':
            ...
            if farthest_point is not None:
                ...
                # # Создать маску для фиолетовых линий
                ...
                # # Отладка отображения маски
                # cv2.imshow('Purple Line Mask', purple_line_mask)
                # cv2.imwrite('purple_line_mask.png', purple_line_mask)
                # cv2.waitKey(0)
