                ...
                for contour_inter in contours_intersection:
                    for point in contour_inter[:, 0, :]:
                        if all(int(point_distance(point, dp)) > min_distance for dp in unique_points):
                            ...
                            # cv2.circle(rgba_image, tuple(point), 5, (0, 255, 200), -1)  # Желтая точка
                            ...
                            # cv2.imshow('purple_line_mask', purple_line_mask)
                            ...
                            #     # Рисование зеленой хорды между точками пересечения
                                cv2.line(rgba_image, intersection_points[0], intersection_points[1], (0, 255, 0), 2)  # Толщина изменена на 3
                            ...
                            #     # Продление линии до пересечения с красным радиусом
                                # cv2.line(rgba_image, tuple(point), intersection_points[0], (255, 0, 255), 6)  # Толщина изменена на 3
                                # cv2.line(rgba_image, tuple(point), intersection_points[1], (255, 0, 255), 6)  # Толщина изменена на 3
                                
                            #     # Пометить точку как использованную
                            #     used_points.add(tuple(point))
