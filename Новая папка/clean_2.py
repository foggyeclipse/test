...
def process_intersections(contours_intersection, min_distance, center, center_of_mass, purple_line_mask, circle_center, circle_radius):
    ...
    if len(chord_ends) == 2:
        ...
        red_arc_mask = draw_red_arc_mask(contour_red_circle_mask, chord_starts[0], chord_starts[1], circle_center, circle_radius)
        # red_arc_mask1 = red_arc_mask
...
image = cv2.imread('test_circles.png')
